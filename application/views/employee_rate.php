        ...
        <div class="card-box">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <?php $updateCategory_success = $this->session->userdata('update_amount_success');
        ...
        if($rate_success != "" ){ ?>
                    ...
                    <form action="<?php echo base_url(); ?>admin/CreateRateAmount" method="POST">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="rate_amount" placeholder="Create Rate Amount">
                ...
                <div class="col-md-6">
                        ...
                        <table class="table table-hover table-centered table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> <a href="<?php echo base_url('admin/EditRateAmount/'.$amount['rate_id']);?>"
                                            class="btn btn-sm btn-custom"><i class="mdi mdi-table-edit"></i></a>
                                        <a href="<?php echo base_url('admin/DeleteRateAmount/'.$amount['rate_id']);?>"
                    ...
                    <div class="row">
                        <?php $rateamount_Delete = $this->session->userdata('DeleteRateAmount');
        if($rateamount_Delete != "" ){ ?>
                        <div class="alert alert-dismissible alert-success">
                            <button type="button" class="close" data-dismiss="alert">&times;</button>
