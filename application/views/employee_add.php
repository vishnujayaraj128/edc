    ...
    <div class="col-lg-6">
        <div class="card-box">
            ...
            <div class="form-group">
                ...
                <div>
                    <div class="input-group">
                        <input class="form-control" autocomplete="off" name="empDateOfBirth" id="datepicker-autoclose"
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="empGuardian" name="empGuardian" value=" "
                    placeholder="Guardian">
            </div>

            <div class="form-group">
                <label>Religion<span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="empReligion" name="empReligion" value=" "
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="empSubCaste" name="empSubCaste" value=" "
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="empCasteGroup" name="empCasteGroup" value=" "
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="empEducation" name="empEducation" value=" "
        ...
        <div class="card-box">
            <div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="empMobile" name="empMobile" value=" "
                        placeholder="Mobile">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="empAdhar" name="empAdhar" value=" "
            ...
            <div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="empBankName" name="empBankName" value=" "
                        placeholder="Bank Name">
                </div>
                <div class="form-group">
                    <label>Branch Name<span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="empBranchName" name="empBranchName" value=" "
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="empAccountNumber" name="empAccountNumber" value=" "
            ...
            <div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="empEmployeeID" name="empEmployeeID" value=" "
